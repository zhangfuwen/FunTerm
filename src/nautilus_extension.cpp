...
static void
nautilus_funterm_menu_provider_init(NautilusFuntermMenuProvider * nl) {}
static void
nautilus_funterm_menu_provider_finalize(GObject* gobject)
{
...
{
    nautilus_funterm_menu_provider_register_type(module);
}
